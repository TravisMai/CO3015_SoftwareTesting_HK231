...
class TestBoundarywithnormalfilesize():
  ...
  def test_boundarywithnormalfilesize(self):
    ...
    self.driver.find_element(By.NAME, "repo_upload_file").send_keys("C:\\fakepath\\Testing_Pro2.pdf")
