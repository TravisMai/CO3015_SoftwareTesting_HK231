...
class TestBoundarywithmaximumfilesize():
  ...
  def test_boundarywithmaximumfilesize(self):
    ...
    self.driver.find_element(By.NAME, "repo_upload_file").send_keys("C:\\fakepath\\Testing_Pro2_max.pdf")
