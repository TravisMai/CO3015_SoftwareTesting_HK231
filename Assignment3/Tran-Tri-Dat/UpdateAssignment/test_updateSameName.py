...
class TestUpdateSameName():
  ...
  def test_updateSameName(self):
    # Test name: test_updateSameName
    ...
    # 22 | type | id=id_name | Updated
    self.driver.find_element(By.ID, "id_name").send_keys("Assignment 1")
    # 23 | click | id=id_submitbutton2 | 
    self.driver.find_element(By.ID, "id_submitbutton2").click()


    # 24 | click | id=user-menu-toggle | 
    self.driver.find_element(By.ID, "user-menu-toggle").click()
    # 25 | waitForElementVisible | css=#carousel-item-main > .dropdown-item:nth-child(12) | 30000
    ...
    # 26 | click | css=#carousel-item-main > .dropdown-item:nth-child(12) | 
