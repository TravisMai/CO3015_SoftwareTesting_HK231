...
class TestPassingGrade():
  ...
  def test_passingGrade(self):
    ...
    # 15 | click | id=collapseElement-10 | 
    ...
    # 22 | click | css=#carousel-item-main > .dropdown-item:nth-child(12) | 
